// Made with p5js framework
// Stroke width
var strokeW = 2;
var pos = 0;
var frame = 5;
var walkersQtd = 4;
// Also, the speed of progration of each walker
var step = 25;
...
// Draw a frame on the upper left corner with the actual amount of walker on the screen
...
function setup() {
    const element_bg = document.querySelector('.page-bg');
    console.log(element_bg);
    createCanvas(windowWidth-12, windowHeight-5);
	for(let i = 0; i < walkersQtd; i++) {
        walkers.push(new Walker(null, null));
	}
    let c = color(element_bg.style.backgroundColor);
    background(c);
    noSmooth();
}
